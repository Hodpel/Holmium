            ...
            <article key={post.id} className="group mb-6 md:mb-8 flex flex-row gap-4 items-start">
                ...
                <div className="flex-1 min-w-0">
                    <header className="flex flex-col justify-between md:flex-row md:items-baseline">
                        <h2 className="flex items-center gap-2 text-lg md:text-3xl font-bold md:mb-2 cursor-pointer text-black dark:text-gray-100 group-hover:text-theme min-w-0 flex-1 transition ">
